...
const AuthSidebar = ({variant = "login"}) => {
  ...
  const sidebarContent = {
    login: {
      ...
      subTitle : "Join SkillBridge. Your next breakthrough is just a connection away",
    },
    signup: {
      title : "Start Learning Today",
      subTitle : "Create your account and start exchanging skills with a global community of learners and mentors.",
      points : [
